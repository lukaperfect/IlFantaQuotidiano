...
async function main(): Promise<void> {
   ...
   */
  const copertura = finestraSempreAperta();
  ok(`il calendario finto apre la finestra a QUALUNQUE ora — ${copertura.minuti} minuti provati`,
     copertura.buchi === 0, `${copertura.buchi} minuti con la finestra chiusa`);
